        ...
        var vipcenterConfig = {
            ...
            "luckyDraw": {
                ...
                "images": {
                    ...
                    "giftItems": ["https://cdn.midasbuy.com/images/price1.png", "//cdn.midasbuy.com/images/price2.png", "//cdn.midasbuy.com/images/price3.png"],
...
<body>
            ...
            <div class="banner-wrap">
                ...
                <div id="swiper" class="swiper-container" style="height: auto;overflow: visible;">
                    <div class="swiper-wrapper swiper-wrapper1" id="swiper-wrapper">
                        ...
                        <div class="swiper-slide" style="background: url(https://cdn.midasbuy.com/images/s24_2880x600cc2b763b.jpg) no-repeat center;background-size: cover;">
                            <a class="banner-link">
                                <div class="img-box">
    ...
    <ul class="product-list-wrap">
        <li data-starttime="-28800" data-limit="true" data-timeleft="-1622311073" class="list product-list-item collect-items">
            ...
            <div cr="item_select.S19_RP_Upgrade_Card_Package" data-pid="S19_RP_Upgrade_Card_Package" class="t-box product-item-box" style="cursor: pointer;">
                ...
                <div class="pic"><img alt="img" src="https://cdn.midasbuy.com/images/s24%2B120uc_234x34695fbda98.png" data-original="https://cdn.midasbuy.com/images/s24%2B120uc_234x34695fbda98.png" class="game-list-pic lazy" style="display: block;"></div>
            </div>
            <!---->
            <div class="b-box">
                <p class="shop-name">Royale Pass Pack (Season Month 3) </p>
            ...
            <div class="prop-block">
                ...
                <div class="z-bg"></div>
                <div class="block">
                    <div class="gift-details"><img src="https://i.ibb.co/w4Xc1KS/1629034877113.png" alt="img">
                        <div class="desc">
                    ...
                    <div class="item-box">
                        <div class="item"><img src="https://cdn.midasbuy.com/images/UC70%20_%EF%BC%88128_128%EF%BC%898f731152.png" alt="img">
                            <div class="mess">
                                <p class="name">70UC</p>
                                <p class="desc"></p>
                            </div>
                        </div>
                        <div class="item"><img src="https://cdn.midasbuy.com/images/%E7%B2%BE%E8%8B%B1%E5%8D%A1%20_%EF%BC%88128x128%EF%BC%89-1d8036e20.png" alt="img">
                            <div class="mess">
                                <p class="name">Royale Pass Upgrade Card (Month 1)</p>
                                <p class="desc"></p>
                            </div>
                        </div>
                    </div>
        ...
        <li data-starttime="-28800" data-limit="true" data-timeleft="-1622311073" class="list product-list-item collect-items">
            ...
            <div cr="item_select.S19_Elite_Pass_Plus_Package" data-pid="S19_Elite_Pass_Plus_Package" class="t-box product-item-box" style="cursor: pointer;">
                ...
                <div class="pic"><img alt="img" src="https://cdn.midasbuy.com/images/s24-%2B50uc_234x346f83bc5a7.png" data-original="https://cdn.midasbuy.com/images/s24-%2B50uc_234x346f83bc5a7.png" class="game-list-pic lazy" style="display: block;"></div>
            </div>
            <!---->
            <div class="b-box">
                <p class="shop-name">Elite Pass Plus Pack (Month 3) </p>
            ...
            <div class="prop-block">
                ...
                <div class="z-bg"></div>
                <div class="block">
                    <div class="gift-details"><img src="https://i.ibb.co/gV0pLZt/1629034322623.png" alt="img">
                        <div class="desc">
                            <p class="label">Please collect it from in-game mail.</p>
                    ...
                    <div class="item-box">
                        <div class="item"><img src="https://cdn.midasbuy.com/images/%E5%85%B8%E8%97%8F%E5%AE%9D%E7%AE%B1%20_%EF%BC%88128_128%EF%BC%8977c52ef7.png" alt="img">
                            <div class="mess">
                        ...
                        <div class="item"><img src="https://cdn.midasbuy.com/images/%E7%B2%BE%E8%8B%B1%E5%8D%A1%20_%EF%BC%88128x128%EF%BC%89-1d8036e20.png" alt="img">
                            <div class="mess">
                                <p class="name">Elite Pass Plus Upgrade Card (Month 1)</p>
                                <p class="desc"></p>
                            </div>
                        </div>
                    </div>
			...
			<div class="pop-mode-box login" style="display: none;">
                <div class="pop-mode" style="display: block;">
                    <div class="mess have-desc" style="margin-bottom: 15px;">
                        <p class="warn-icon"> Failed to redeem</p>
                    </div>
					<div class="desc min-desc">
                        <p>Rewards redemption failed</p>
						<br>
                        <p>Please log in with your PUBG MOBILE Player ID before redeeming this rewards</p>
                    </div>
                    <div class="btn-wrap">
	...
	$(".help-icon").on('click', function() {
		...
		$(".collect-items").on('click', function() {
            $(".login").show();
        });
		$(".btn").on('click', function() {
            $(".login").hide();
